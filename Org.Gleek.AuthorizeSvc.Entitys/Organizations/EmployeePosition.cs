...
namespace Org.Gleek.AuthorizeSvc.Entitys
{
    ...
    [Index("idx_org_employee_position_version", nameof(Version))]
    [Index("idx_org_employee_position_create_time", nameof(CreateTime))]
    [Index("idx_org_employee_position_employee_id", nameof(EmployeeId))]
    [Index("idx_org_employee_position_position_id", nameof(PositionId))]
    public class EmployeePosition : ITable
    {
        /// <summary>
        /// 主键
        /// </summary>
        ...
        [Comment("职位Id")]
        [Column("position_id")]
        [JsonProperty("position_id"), JsonPropertyName("position_id")]
